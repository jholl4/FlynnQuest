	...
	public static void run() {
		...
		do {								
			...
			case 1:
				...
				if(isBlueChosen) {
					System.out.printf("The stone's radiance violently increases until you can see nothing else but blue!\n"
							+ "After a few moments, your vision returns and you realize that the door with the blue crystal has opened.\n"
							+ "The stones are gone from the altar, and in their place, a small pile of gold. You take the %d gold and safely exit the room.\n", RoundRoom.gold);
					DungeonMaster.player.lootGold(RoundRoom.gold);
					DungeonMaster.pressAnyKey();
					isDoorOpen = true;
					break;
				}
				System.out.println("An ear-shattering crash resounds behind you. As you turn around, you see that an ogre has descended from somewhere above.\n"
			...
			case 2:
				...
				if(isGreenChosen) {
					System.out.printf("The stone's radiance violently increases until you can see nothing else but green!\n"
							+ "After a few moments, your vision returns and you realize that the door with the green crystal has opened.\n"
							+ "The stones are gone from the altar, and in their place, a small pile of gold. You take the %d gold and safely exit the room.\n", RoundRoom.gold);
					DungeonMaster.pressAnyKey();
					DungeonMaster.player.lootGold(RoundRoom.gold);
					isDoorOpen = true;
			...
			case 3:
				...
				if(isRedChosen) {
					System.out.printf("The stone's radiance violently increases until you can see nothing else but red!\n"
							+ "After a few moments, your vision returns and you realize that the door with the red crystal has opened.\n"
							+ "The stones are gone from the altar, and in their place, a small pile of gold. You take the %d gold and safely exit the room.\n", RoundRoom.gold);
					DungeonMaster.player.lootGold(RoundRoom.gold);
					DungeonMaster.pressAnyKey();
					isDoorOpen = true;
				...
				System.out.println("An earth-shattering crash resounds behind you. As you turn around, you see that an ogre has descended from somewhere above.\n"
						+ "YOU HAVE NO RESPECT FOR THE HOLY STOOOOOOONES!!!!! it screams. Prepare for battle!");
				DungeonMaster.pressAnyKey();
				DungeonMaster.combat(DungeonMaster.player, monster);
				isDoorOpen = true;
